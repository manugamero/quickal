      ...
      <div className="flex min-h-screen items-center justify-center px-4">
        <div className="flex w-full max-w-xs flex-col items-center gap-10 text-center">
          ...
          >
            <button
              type="submit"
              className="flex items-center gap-2.5 rounded-lg border border-border bg-bg-secondary px-5 py-2.5 text-sm font-medium text-text transition-colors hover:bg-bg-tertiary active:scale-[0.98]"
            >
